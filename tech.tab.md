...
| M132	 | 	альтернативная процедура цилиндрической разбивки контура	 | 	 	 |	 	|
...
| M330	 | 	Переместить манимулятор в указанное положение	 | 	 	 |	 	|
| M331	 | 	Извлечь или зажать из/в манипулятора деталь	 | 	 	 |	 	|
| M332	 | 	сервисные команды манипулятора	 | 	 	 |	 	|
| M333	 | 	Извлечь из рабочей зоны деталь деталь	 | 	 	 |	 	|
| M334	 | 	Установить содержимое ячейки паллета	 | 	 	 |	 	|
| M335	 | 	Выбрать из слота	 | 	 	 |	 	|
| M336	 | 	Вернуть в слот	 | 	 	 |	 	|
| M338	 | 	Выполнить задачу	 | 	 	 |	 	|
| M339	 | 	Отладочные команды	 | 	 	 |	 	|
...
| M629	 | 	угол разворота "кромка XY-Z" + поворот по C	 | 	 	 |	 	|
...
| M776	 | 	параллельность по оси C+Y	 | 	 	 |	 	|
...
| M778	 | 	установить указанные координаты	 | 	имена координат и значения, которые следует установить.	 |	N10 M778(X10Y0.4)	|
...
| M821	 | 	получение параметра настроек	 | 	номер параметра	 |	 	|
...
| M990	 | 	Пауза выполнения программы (в секундах)	 | 	время в секундах	 |	N10 M990(2.5)	|
