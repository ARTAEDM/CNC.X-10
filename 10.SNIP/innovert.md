...
1. Pb17 = 8
2. Выключить питание преобразователя
3. Включить питание преобразователя

Для исключения случайных искажений, рекомендуется выполнить сброс до **```заводских настроек```** 
перед началом окончательной настройки.
