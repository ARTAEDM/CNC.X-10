...
## Доступ к файлу
 ...
 Корень системы находиться в каталоге **/media/sda1/CNC**. Система работает 
 ...
 Для перехода в коренной каталог СЧПУ введите в командной строке ```cd /media/sda1/CNC```
 
## Действия необходимые для изменения конфигурации

1. войти в операционную оболочку   - ```CTRL+ALT+m```
2. перейти в коренной каталог СЧПУ - ```cd /media/sda1/CNC```
