...
## Доступ к файлу
 ...
 Корень системы находиться в каталоге **/media/SYS/CNC**. Система работает 
 ...
 Для перехода в коренной каталог СЧПУ введите в командной строке ```cd /media/SYS/CNC```
 
## Действия необходимые для изменения конфигурации

1. войти в операционную оболочку   - ```CTRL+ALT+m```
2. перейти в коренной каталог СЧПУ - ```cd /media/SYS/CNC```
