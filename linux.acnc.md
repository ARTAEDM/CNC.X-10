...
Скачиваем **[актуальное](ACNC/UPD.UNI.V2-253G.zip)** обновление или любое доступное из **[истории](#История-версий)** и
...
* 02-247: Скорректрованы скорости обработки UV координат. **Требуется обновление RCNC до версии 3.10**.
          Исправлены техкоманды использующие движение координат.
* [02-242](ACNC/UPD.UNI.V2-242G.zip): Добавлена возможность восстановления задачь с активным шпинделем.
