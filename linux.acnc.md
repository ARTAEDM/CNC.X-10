...
Скачиваем **[актуальное](ACNC/UPD.LITE.V2-321G.zip)** обновление или любое доступное из **[истории](#история-версий)** и
...
## История версий:
* [02-321](ACNC/UPD.LITE.V2-319G.zip): Повышена стабильность работы с частотным преобразователем Mitsubishi. Добавлен поиск центра по 3 точкам в 2х координатные системы.
* 02-321: Исправлено пропадание перманентного натяжения после быстрой перезагрузки СЧПУ.
