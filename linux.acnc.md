...
Скачиваем **[актуальное](ACNC/UPD.LITE.V2-315G.zip)** обновление или любое доступное из **[истории](#история-версий)** и
...
* 02-306: Добалена обработка конкатинатора строк в конфигурациях.
* 02-305: Удалён бросок напряжения при включении выверки.
* 02-304: Добалены числовые метки параметров и универсальный доступ к ним.
