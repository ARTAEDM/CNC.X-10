...
printLines(org)
rw()
setValueToLines(org,"[gen]","use.im",[[0		; 	{id=0551;group="ВЫВЕРКА";cap="Режим 'Без следов'";type="BНЕТ;ДА";help="Использовать режим 'Без следов' при выверке"}]])
setValueToLines(org,"[setmirror]","GEN-MSUB",[[gen/use.im]])
